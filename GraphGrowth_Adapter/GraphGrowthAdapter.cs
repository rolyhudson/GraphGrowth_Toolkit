...
namespace BH.Adapter.GraphGrowth
{
    public partial class GraphGrowthAdapter : BHoMAdapter
    {
        /***************************************************/
        /**** Constructors                              ****/
        /***************************************************/

        [Description("Adapter for GraphGrowth.")]
        [Output("The created GraphGrowth adapter.")]
        public GraphGrowthAdapter()
        {
